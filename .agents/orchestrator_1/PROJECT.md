...
|---|------|-------|-------------|--------|
| M1 | Core Foundation, Storage & Security | Package.swift, AmendCore target, Core Data Models (Cue, AudioTrackMapping, ProjectBundle, ProjectMetadata), APFS copyItem cloning vs Bookmark fallback, Project bundle serialization (.amend/project.json), Keychain Credential Vault (kSecClassGenericPassword) | none | PLANNED |
