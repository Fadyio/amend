...
| M2 | Audio Routing & Fixed-Slot Composition Engine | AudioTrackInspector (1 track -> advisory, >1 -> modal), Fixed-slot Composition Engine enforcing immutable CMTime boundaries, Cue splitting with zero gap/overlap, Boundary Crossfader (10–20ms), Loudness Normalizer, Passthrough track preservation | M1 | IN_PROGRESS |
