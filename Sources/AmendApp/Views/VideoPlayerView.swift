...
public final class AmendPlayerNSView: NSView {
...
public struct VideoPlayerView: NSViewRepresentable {
    ...
    public func makeNSView(context: Context) -> AmendPlayerNSView {
        let view = AmendPlayerNSView(player: player)
        return view
    }

    public func updateNSView(_ nsView: AmendPlayerNSView, context: Context) {
