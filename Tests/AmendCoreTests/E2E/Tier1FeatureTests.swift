...
final class Tier1FeatureTests {
    ...
    init() throws {
        ...
        self.tempDirectory = FileManager.default.temporaryDirectory
            .appendingPathComponent("AmendTier1Tests_\(uniqueID)", isDirectory: true)
    ...
    func test_feature15_bundle_with_fixture1_cloned() async throws {
        ...
        let bundleURL = tempDirectory.appendingPathComponent("ProjectF1.amend")
    ...
    func test_feature15_bundle_with_fixture2_bookmark() async throws {
        ...
        let bundleURL = tempDirectory.appendingPathComponent("ProjectF2.amend")
    ...
    func test_feature15_bundle_cue_wav_persistence() async throws {
        let bundleURL = tempDirectory.appendingPathComponent("CueAudioProject.amend")
        var cue = Cue(
    ...
    func test_feature15_room_tone_metadata_persistence() throws {
        let bundleURL = tempDirectory.appendingPathComponent("RoomToneProject.amend")
        let metadata = ProjectMetadata(
    ...
    func test_feature15_fixed_slot_invariance_on_save_load() throws {
        ...
        let bundleURL = tempDirectory.appendingPathComponent("InvariantProject.amend")
        let metadata = ProjectMetadata(
