...
final class StorageAPFSTests {
    ...
    init() throws {
        ...
        self.tempDirectory = FileManager.default.temporaryDirectory
            .appendingPathComponent("AmendStorageTests_\(uniqueID)", isDirectory: true)
    ...
    func test_apfs_copyItem_creates_clone_source_file() throws {
        ...
        let bundleURL = tempDirectory.appendingPathComponent("TestProject.amend", isDirectory: true)
    ...
    func test_project_bundle_directory_scaffolding() throws {
        let bundleURL = tempDirectory.appendingPathComponent("ScaffoldTest.amend")
        let metadata = ProjectMetadata(
            name: "ScaffoldTest",
